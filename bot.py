...
TOPUP_CHOOSING_CRYPTO, TOPUP_CHOOSING_AMOUNT, TOPUP_WAITING_TX = range(2, 5)

# In-memory sessions
user_sessions = {}

# --- BACKEND API ---
API_URL = "https://api.base44.com/api/apps/69e00594222f3c79030a6942/functions/getBotData"
...
def main():
    ...
    topup_conv = ConversationHandler(
        ...
        states={
            ...
            TOPUP_CHOOSING_AMOUNT:  [CallbackQueryHandler(topup_show_wallet, pattern=r"^ta_")],
